---
title: "Analysis of the Adverse Health and Economic Impacts of US Storm Data"
author: "J Prince Kelvin"
date: "10/11/2021"
output: html_document
---

Github repo for the Course: [Reproducible Research](https://github.com/jpkelvin/datasciencecoursera/tree/master/5_Reproducible_Research/project2)

## 1: Synopsis
The objective of this assignment is to explore the NOAA Storm Database and explore the effects of severe weather events on both population and economy.The database covers the time period between 1950 and November 2011.

The following analysis determines which types of weather events are most harmful with respect to:

1. Population Health 
2. Economic Consequences

Documentation of the Data: [Documentation](hps://d396qusza40orc.cloudfront.net/repdata%2Fpeer2_doc%2Fpd01016005curr.pdf)
...
download.file(fileUrl, destfile = paste0("", '/repdata%2Fdata%2FStormData.csv.bz2'))
